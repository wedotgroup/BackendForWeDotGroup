...
@section('content')
 @if ($errors->any())
    ...
    <!-- Main form container -->
    <form class="max-w-6xl mx-auto space-y-6" action="{{ route('admin.cuopon.update', $cuopon->id) }}" method="POST">
@csrf
            ...
            <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 gap-y-5">
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" id="code" value="{{ $cuopon->code ?? '' }}" name="code"
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <select id="type" name="type"
                            ...
                            <option value="fixed" @selected($cuopon->type == 'fixed')>Fixed Amount (₹)</option>
                            <option value="percentage" @selected($cuopon->type == "percentage")>Percentage (%)</option>
                        </select>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="number" id="value" value="{{ $cuopon->value ?? "" }}" name="value" step="0.01" min="0" placeholder="0.00"
                            class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all duration-200 placeholder-gray-400 text-gray-800 bg-gray-50/40 hover:bg-white focus:bg-white text-sm font-medium"
                            required>
                    </div>
                </div>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <select id="status" name="status"
                            class="w-full pl-10 pr-10 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all duration-200 bg-gray-50/40 hover:bg-white focus:bg-white text-sm font-medium text-gray-800 appearance-none cursor-pointer">
                            <option value="active" selected @selected($cuopon->status == "active")>Active</option>
                            <option value="inactive" @selected($cuopon->status == "inactive")>Inactive</option>
                        </select>
                        <span class="absolute inset-y-0 right-0 flex items-center pr-3.5 pointer-events-none text-gray-400">
                            <i class="fas fa-chevron-down text-xs"></i>
                        </span>
            ...
            <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 gap-y-5">
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="number" id="minimum_order_amount" value="{{ $cuopon->minimum_order_amount ?? "" }}" name="minimum_order_amount" step="0.01"
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="number" value="{{ $cuopon->maximum_discount ?? "" }}" id="maximum_discount" name="maximum_discount" step="0.01"
                            min="0" placeholder="0.00"
                            class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all duration-200 placeholder-gray-400 text-gray-800 bg-gray-50/40 hover:bg-white focus:bg-white text-sm font-medium">
                    </div>
                </div>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="number" id="usage_limit" value="{{ $cuopon->usage_limit ?? "" }}" name="usage_limit" min="1" step="1"
                            placeholder="e.g. 100"
                            class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all duration-200 placeholder-gray-400 text-gray-800 bg-gray-50/40 hover:bg-white focus:bg-white text-sm font-medium">
                    </div>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="number" id="used_count" value="{{ $cuopon->used_count ?? "" }}" name="used_count" value="0" readonly
            ...
            <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 gap-y-5">
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="datetime-local" value="{{ $cuopon->start_date ?? "" }}" id="start_date" name="start_date"
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        ...
                        <input type="datetime-local" id="expiry_date" name="expiry_date" value="{{ $cuopon->expiry_date ?? "" }}"
                            class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all duration-200 text-gray-800 bg-gray-50/40 hover:bg-white focus:bg-white text-sm font-medium">
                    </div>
                </div>
            </div>
